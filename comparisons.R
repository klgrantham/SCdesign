...
varSCSW_plot_general(10, 3, 1, 10, 3, 2, 1, 1, 0, 'cat')
varSCSW_plot_general(10, 3, 1, 10, 3, 2, 1, 1, 0, 'lin')

# SW design with 3 clusters, 4 periods vs.
# SC design with 3 clusters, 4 periods per sequence
# (3+2+2-1=6 periods total)
# Note: Designs have same total number of cluster-periods
varSCSW_plot_general(10, 3, 1, 10, 3, 1, 2, 2, 0, 'cat')
varSCSW_plot_general(10, 3, 1, 10, 3, 1, 2, 2, 0, 'lin')
...
# Note: This is the embedded staircase design
varSCSW_plot_general(10, 7, 3, 10, 7, 3, 1, 1, 0, 'cat')
...
varSCSW_plot_general(100, 7, 3, 100, 7, 3, 1, 1, 0, 'cat')
